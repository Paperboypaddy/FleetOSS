...
export type EventType = 'deviceOnline' | 'deviceOffline' | 'deviceMoving' | 'deviceStopped' | 'geofenceEnter' | 'geofenceExit' | 'alarm' | 'ignitionOn' | 'ignitionOff' | 'maintenance' | 'speeding' | 'report';
